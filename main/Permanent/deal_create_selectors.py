...
MAIN_INFO_BLOCK = {'by': 'By.CSS_SELECTOR',
...
STAGE_SELECT = {'by': 'By.CSS_SELECTOR',
...
SETTLEMENT_DATE = {'by': 'By.CSS_SELECTOR',
...
PERSON_NAME = {'by': 'By.CSS_SELECTOR',
               'value': 'md-autocomplete-wrap > md-input-container > input'}
PERSON_SURNAME = {'by': 'By.CSS_SELECTOR',
                  'value': 'div:nth-child(2) > div:nth-child(2) > md-input-container > input'}
PERSON_NUM_PREFIX = {'by': 'By.CSS_SELECTOR',
                     'value': 'div:nth-child(3) > md-input-container:nth-child(1) > input'}
PERSON_EMAIL = {'by': 'By.CSS_SELECTOR',
                'value': 'div:nth-child(2) > div:nth-child(4) > md-input-container > input'}
COMPANY_NAME = {'by': 'By.CSS_SELECTOR',
                'value': 'md-autocomplete-wrap > md-input-container > input'}
COMPANY_NUM_PREFIX = {'by': 'By.CSS_SELECTOR',
                      'value': 'div:nth-child(2) > md-input-container:nth-child(1) > input'}
COMPANY_EMAIL = {'by': 'By.CSS_SELECTOR', 'value': 'div > div:nth-child(3) input'}

# Select deal owner
DEAL_OWNER_MD = {'by': 'By.CSS_SELECTOR',
                 'value': 'div:nth-child(2) > md-input-container > md-select'}
DEAL_OWNER_LIST = {'by': 'By.CSS_SELECTOR', 'value': 'md-option > div > span'}
CONTACT_LABEL = {'by': 'By.CSS_SELECTOR',
                 'value': 'md-autocomplete-wrap > md-input-container > label'}
